 ...
 * on 2016-01-25 at 16:44:50 UTC 
 * Modify at your own risk.
 */

package com.example.saram.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public Login login(java.lang.String name) throws java.io.IOException {
    Login result = new Login(name);
    initialize(result);
    return result;
  }

  public class Login extends MyApiRequest<com.example.saram.myapplication.backend.myApi.model.MyBean> {

    private static final String REST_PATH = "login/{name}";
     ...
     * @since 1.13
     */
    protected Login(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.saram.myapplication.backend.myApi.model.MyBean.class);
  ...
  public class SayHi extends MyApiRequest<com.example.saram.myapplication.backend.myApi.model.MyBean> {
