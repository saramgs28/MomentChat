 ...
 * on 2016-01-27 at 15:27:08 UTC 
 * Modify at your own risk.
 */

package com.example.saram.myapplication.backend.userApi;
...
public class UserApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://momentchat-1201.appspot.com/_ah/api/";
  ...
  public class GetUser extends UserApiRequest<com.example.saram.myapplication.backend.userApi.model.User> {
    ...
    protected GetUser(java.lang.String id) {
      super(UserApi.this, "GET", REST_PATH, null, com.example.saram.myapplication.backend.userApi.model.User.class);
   ...
   *
   * @param content the {@link com.example.saram.myapplication.backend.userApi.model.User}
   * @return the request
   */
  public InsertUser insertUser(com.example.saram.myapplication.backend.userApi.model.User content) throws java.io.IOException {
    InsertUser result = new InsertUser(content);
    initialize(result);
    return result;
  }

  public class InsertUser extends UserApiRequest<com.example.saram.myapplication.backend.userApi.model.User> {
     ...
     * @since 1.13
     */
    protected InsertUser(com.example.saram.myapplication.backend.userApi.model.User content) {
      super(UserApi.this, "POST", REST_PATH, content, com.example.saram.myapplication.backend.userApi.model.User.class);
    }
